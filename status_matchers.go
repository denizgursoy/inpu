...
// StatusAny matches any status code. It can be used as fallback in case previous OnWhen matches is not called
// It has the least priority 10, and it is checked after StatusAnyExceptOneOf
// Usage:
// OnWhen(StatusAny,func(r *http.Response) error{})
...
// Usage:
// OnWhen(StatusAnyExceptOneOf(http.StatusOK,http.StatusCreated),func(r *http.Response) error{})
...
// Usage:
// OnWhen(StatusAnyExcept(http.StatusOK),func(r *http.Response) error{})
...
// Usage:
// OnWhen(StatusIsSuccess,func(r *http.Response) error{})
...
// It has the priority 3, and it is checked after StatusIsOneOf.
// Usage:
// OnWhen(StatusIsInformational,func(r *http.Response) error{})
...
// It has the priority 3, and it is checked after StatusIsOneOf.
// Usage:
// OnWhen(StatusIsRedirection,func(r *http.Response) error{})
...
// It has the priority 3, and it is checked after StatusIsOneOf.
// Usage:
// OnWhen(StatusIsClientError,func(r *http.Response) error{})
...
// It has the priority 3, and it is checked after StatusIsOneOf.
// Usage:
// OnWhen(StatusIsServerError,func(r *http.Response) error{})
...
// Usage:
// OnWhen(StatusIsOneOf(http.StatusOK,http.StatusCreated),func(r *http.Response) error{}) -> only matches when the status code is either 200,201
...
// Usage:
// OnWhen(StatusIs(http.StatusOK),func(r *http.Response) error{}) -> only matches when the status code is 200
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsContinue, func(r *http.Response) error{}) -> only matches when the status code is 100
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsSwitchingProtocols, func(r *http.Response) error{}) -> only matches when the status code is 101
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsProcessing, func(r *http.Response) error{}) -> only matches when the status code is 102
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsEarlyHints, func(r *http.Response) error{}) -> only matches when the status code is 103
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsOk, func(r *http.Response) error{}) -> only matches when the status code is 200
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsCreated, func(r *http.Response) error{}) -> only matches when the status code is 201
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsAccepted, func(r *http.Response) error{}) -> only matches when the status code is 202
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsNonAuthoritativeInfo, func(r *http.Response) error{}) -> only matches when the status code is 203
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsNoContent, func(r *http.Response) error{}) -> only matches when the status code is 204
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsResetContent, func(r *http.Response) error{}) -> only matches when the status code is 205
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsPartialContent, func(r *http.Response) error{}) -> only matches when the status code is 206
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsMultiStatus, func(r *http.Response) error{}) -> only matches when the status code is 207
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsAlreadyReported, func(r *http.Response) error{}) -> only matches when the status code is 208
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsIMUsed, func(r *http.Response) error{}) -> only matches when the status code is 226
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsMultipleChoices, func(r *http.Response) error{}) -> only matches when the status code is 300
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsMovedPermanently, func(r *http.Response) error{}) -> only matches when the status code is 301
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsFound, func(r *http.Response) error{}) -> only matches when the status code is 302
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsSeeOther, func(r *http.Response) error{}) -> only matches when the status code is 303
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsNotModified, func(r *http.Response) error{}) -> only matches when the status code is 304
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsUseProxy, func(r *http.Response) error{}) -> only matches when the status code is 305
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsTemporaryRedirect, func(r *http.Response) error{}) -> only matches when the status code is 307
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsPermanentRedirect, func(r *http.Response) error{}) -> only matches when the status code is 308
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsBadRequest, func(r *http.Response) error{}) -> only matches when the status code is 400
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsUnauthorized, func(r *http.Response) error{}) -> only matches when the status code is 401
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsPaymentRequired, func(r *http.Response) error{}) -> only matches when the status code is 402
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsForbidden, func(r *http.Response) error{}) -> only matches when the status code is 403
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsNotFound, func(r *http.Response) error{}) -> only matches when the status code is 404
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsMethodNotAllowed, func(r *http.Response) error{}) -> only matches when the status code is 405
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsNotAcceptable, func(r *http.Response) error{}) -> only matches when the status code is 406
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsProxyAuthRequired, func(r *http.Response) error{}) -> only matches when the status code is 407
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsRequestTimeout, func(r *http.Response) error{}) -> only matches when the status code is 408
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsConflict, func(r *http.Response) error{}) -> only matches when the status code is 409
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsGone, func(r *http.Response) error{}) -> only matches when the status code is 410
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsLengthRequired, func(r *http.Response) error{}) -> only matches when the status code is 411
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsPreconditionFailed, func(r *http.Response) error{}) -> only matches when the status code is 412
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsRequestEntityTooLarge, func(r *http.Response) error{}) -> only matches when the status code is 413
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsRequestURITooLong, func(r *http.Response) error{}) -> only matches when the status code is 414
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsUnsupportedMediaType, func(r *http.Response) error{}) -> only matches when the status code is 415
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsRequestedRangeNotSatisfiable, func(r *http.Response) error{}) -> only matches when the status code is 416
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsExpectationFailed, func(r *http.Response) error{}) -> only matches when the status code is 417
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsTeapot, func(r *http.Response) error{}) -> only matches when the status code is 418
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsMisdirectedRequest, func(r *http.Response) error{}) -> only matches when the status code is 421
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsUnprocessableEntity, func(r *http.Response) error{}) -> only matches when the status code is 422
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsLocked, func(r *http.Response) error{}) -> only matches when the status code is 423
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsFailedDependency, func(r *http.Response) error{}) -> only matches when the status code is 424
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsTooEarly, func(r *http.Response) error{}) -> only matches when the status code is 425
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsUpgradeRequired, func(r *http.Response) error{}) -> only matches when the status code is 426
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsPreconditionRequired, func(r *http.Response) error{}) -> only matches when the status code is 428
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsTooManyRequests, func(r *http.Response) error{}) -> only matches when the status code is 429
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsRequestHeaderFieldsTooLarge, func(r *http.Response) error{}) -> only matches when the status code is 431
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsUnavailableForLegalReasons, func(r *http.Response) error{}) -> only matches when the status code is 451
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsInternalServerError, func(r *http.Response) error{}) -> only matches when the status code is 500
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsNotImplemented, func(r *http.Response) error{}) -> only matches when the status code is 501
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsBadGateway, func(r *http.Response) error{}) -> only matches when the status code is 502
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsServiceUnavailable, func(r *http.Response) error{}) -> only matches when the status code is 503
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsGatewayTimeout, func(r *http.Response) error{}) -> only matches when the status code is 504
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsHTTPVersionNotSupported, func(r *http.Response) error{}) -> only matches when the status code is 505
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsVariantAlsoNegotiates, func(r *http.Response) error{}) -> only matches when the status code is 506
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsInsufficientStorage, func(r *http.Response) error{}) -> only matches when the status code is 507
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsLoopDetected, func(r *http.Response) error{}) -> only matches when the status code is 508
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsNotExtended, func(r *http.Response) error{}) -> only matches when the status code is 510
...
// It has the priority 1, and it has the top priority.
// Usage:
// OnWhen(StatusIsNetworkAuthenticationRequired, func(r *http.Response) error{}) -> only matches when the status code is 511
