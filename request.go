...
// On adds status matcher and response handler configurations.
...
//
// On(StatusIs(http.StatusOK), ThenReturnError(errors.New("something happened"))). // first one
// On(StatusIsSuccess, ThenReturnError(errors.New("something happened again"))). // second one
// On(StatusAny, ThenReturnError(errors.New("something happened again and again"))) // third one
//
...
//
// On(StatusIs(http.StatusOK), ThenReturnError(errors.New("something happened"))). // first one
// On(StatusIs(http.StatusOK), ThenReturnError(errors.New("something happened again"))) // second one
//
