...
// StatusAny matches any status code. It can be used as fallback in case previous On matches is not called
// It has the least priority 10, and it is checked after StatusAnyExceptOneOf
// Usage:
// On(StatusAny,func(r *http.Response) error{})
...
// Usage:
// On(StatusAnyExceptOneOf(http.StatusOK,http.StatusCreated),func(r *http.Response) error{})
...
// Usage:
// On(StatusAnyExcept(http.StatusOK),func(r *http.Response) error{})
...
// Usage:
// On(StatusIsSuccess,func(r *http.Response) error{})
...
// It has the priority 3, and it is checked after StatusIsOneOf.
// Usage:
// On(StatusIsInformational,func(r *http.Response) error{})
...
// It has the priority 3, and it is checked after StatusIsOneOf.
// Usage:
// On(StatusIsRedirection,func(r *http.Response) error{})
...
// It has the priority 3, and it is checked after StatusIsOneOf.
// Usage:
// On(StatusIsClientError,func(r *http.Response) error{})
...
// It has the priority 3, and it is checked after StatusIsOneOf.
// Usage:
// On(StatusIsServerError,func(r *http.Response) error{})
...
// Usage:
// On(StatusIsOneOf(http.StatusOK,http.StatusCreated),func(r *http.Response) error{}) -> only matches when the status code is either 200,201
...
// Usage:
// On(StatusIs(http.StatusOK),func(r *http.Response) error{}) -> only matches when the status code is 200
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsContinue, func(r *http.Response) error{}) -> only matches when the status code is 100
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsSwitchingProtocols, func(r *http.Response) error{}) -> only matches when the status code is 101
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsProcessing, func(r *http.Response) error{}) -> only matches when the status code is 102
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsEarlyHints, func(r *http.Response) error{}) -> only matches when the status code is 103
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsOk, func(r *http.Response) error{}) -> only matches when the status code is 200
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsCreated, func(r *http.Response) error{}) -> only matches when the status code is 201
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsAccepted, func(r *http.Response) error{}) -> only matches when the status code is 202
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsNonAuthoritativeInfo, func(r *http.Response) error{}) -> only matches when the status code is 203
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsNoContent, func(r *http.Response) error{}) -> only matches when the status code is 204
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsResetContent, func(r *http.Response) error{}) -> only matches when the status code is 205
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsPartialContent, func(r *http.Response) error{}) -> only matches when the status code is 206
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsMultiStatus, func(r *http.Response) error{}) -> only matches when the status code is 207
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsAlreadyReported, func(r *http.Response) error{}) -> only matches when the status code is 208
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsIMUsed, func(r *http.Response) error{}) -> only matches when the status code is 226
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsMultipleChoices, func(r *http.Response) error{}) -> only matches when the status code is 300
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsMovedPermanently, func(r *http.Response) error{}) -> only matches when the status code is 301
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsFound, func(r *http.Response) error{}) -> only matches when the status code is 302
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsSeeOther, func(r *http.Response) error{}) -> only matches when the status code is 303
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsNotModified, func(r *http.Response) error{}) -> only matches when the status code is 304
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsUseProxy, func(r *http.Response) error{}) -> only matches when the status code is 305
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsTemporaryRedirect, func(r *http.Response) error{}) -> only matches when the status code is 307
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsPermanentRedirect, func(r *http.Response) error{}) -> only matches when the status code is 308
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsBadRequest, func(r *http.Response) error{}) -> only matches when the status code is 400
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsUnauthorized, func(r *http.Response) error{}) -> only matches when the status code is 401
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsPaymentRequired, func(r *http.Response) error{}) -> only matches when the status code is 402
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsForbidden, func(r *http.Response) error{}) -> only matches when the status code is 403
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsNotFound, func(r *http.Response) error{}) -> only matches when the status code is 404
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsMethodNotAllowed, func(r *http.Response) error{}) -> only matches when the status code is 405
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsNotAcceptable, func(r *http.Response) error{}) -> only matches when the status code is 406
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsProxyAuthRequired, func(r *http.Response) error{}) -> only matches when the status code is 407
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsRequestTimeout, func(r *http.Response) error{}) -> only matches when the status code is 408
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsConflict, func(r *http.Response) error{}) -> only matches when the status code is 409
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsGone, func(r *http.Response) error{}) -> only matches when the status code is 410
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsLengthRequired, func(r *http.Response) error{}) -> only matches when the status code is 411
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsPreconditionFailed, func(r *http.Response) error{}) -> only matches when the status code is 412
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsRequestEntityTooLarge, func(r *http.Response) error{}) -> only matches when the status code is 413
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsRequestURITooLong, func(r *http.Response) error{}) -> only matches when the status code is 414
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsUnsupportedMediaType, func(r *http.Response) error{}) -> only matches when the status code is 415
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsRequestedRangeNotSatisfiable, func(r *http.Response) error{}) -> only matches when the status code is 416
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsExpectationFailed, func(r *http.Response) error{}) -> only matches when the status code is 417
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsTeapot, func(r *http.Response) error{}) -> only matches when the status code is 418
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsMisdirectedRequest, func(r *http.Response) error{}) -> only matches when the status code is 421
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsUnprocessableEntity, func(r *http.Response) error{}) -> only matches when the status code is 422
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsLocked, func(r *http.Response) error{}) -> only matches when the status code is 423
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsFailedDependency, func(r *http.Response) error{}) -> only matches when the status code is 424
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsTooEarly, func(r *http.Response) error{}) -> only matches when the status code is 425
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsUpgradeRequired, func(r *http.Response) error{}) -> only matches when the status code is 426
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsPreconditionRequired, func(r *http.Response) error{}) -> only matches when the status code is 428
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsTooManyRequests, func(r *http.Response) error{}) -> only matches when the status code is 429
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsRequestHeaderFieldsTooLarge, func(r *http.Response) error{}) -> only matches when the status code is 431
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsUnavailableForLegalReasons, func(r *http.Response) error{}) -> only matches when the status code is 451
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsInternalServerError, func(r *http.Response) error{}) -> only matches when the status code is 500
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsNotImplemented, func(r *http.Response) error{}) -> only matches when the status code is 501
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsBadGateway, func(r *http.Response) error{}) -> only matches when the status code is 502
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsServiceUnavailable, func(r *http.Response) error{}) -> only matches when the status code is 503
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsGatewayTimeout, func(r *http.Response) error{}) -> only matches when the status code is 504
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsHTTPVersionNotSupported, func(r *http.Response) error{}) -> only matches when the status code is 505
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsVariantAlsoNegotiates, func(r *http.Response) error{}) -> only matches when the status code is 506
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsInsufficientStorage, func(r *http.Response) error{}) -> only matches when the status code is 507
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsLoopDetected, func(r *http.Response) error{}) -> only matches when the status code is 508
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsNotExtended, func(r *http.Response) error{}) -> only matches when the status code is 510
...
// It has the priority 1, and it has the top priority.
// Usage:
// On(StatusIsNetworkAuthenticationRequired, func(r *http.Response) error{}) -> only matches when the status code is 511
